...
//  SnipIt
//
//  Created by Hunter Meyer on 3/12/15.
...
struct HTTPHelper {
    static let API_AUTH_NAME = "api_user"
    static let API_AUTH_PASSWORD = "kWPl9RnfTqkJAM6Nq2WViqr0jvNaIGvbSQDfEA9YNcLwxIA6z69Xd23J8yZoSIAn"
    static let BASE_URL = "https://snipitapp.herokuapp.com/api"
    ...
    func uploadRequest(path: String, data: NSData) -> NSMutableURLRequest {
        ...
        let imageMeteData = "Content-Disposition: form-data; name=\"audio\"; filename=\"audio_file\"\r\n".dataUsingEncoding(NSUTF8StringEncoding, allowLossyConversion: false)
